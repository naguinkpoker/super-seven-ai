              ...
              {Gloading ? <TfiReload className="animate-spin" /> : <FcGoogle className='text-2xl' /> }Continue with Google </button>
               ...
               {loading ? <TfiReload className="animate-spin"/> :  <BsTwitter className='text-white'/>}   
                ...
                <p className="text-center px-8">
                  By loging or signing up using the options above, you agree to SuperSevenAI's <Link href="/terms&Condition" className='text-blue-500 underline'>Terms & Conditions</Link> and <Link href="/privacyPolicy" className='text-blue-500 underline'>Privacy Policy</Link> .
                </p>
        </div>
      </div>
    )
