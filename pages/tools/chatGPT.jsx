...
const Chatbot = () => {
  ...
  return (
    ...
    <Head>
    <title>ChatGPT | SuperSevenAI</title>
    </Head>
      <div className="dark:bg-black/50  shadow-lg p-2 rounded-lg">
      <h1 className="text-center text-3xl font-bold text-gray-400"> <span>SuperSeven ChatGPT ✨</span></h1>
       <div className="">
        ...
        <p className='text-center pt-1 opacity-75'>Free Research Preview. ChatGPT may produce inaccurate information about people, places, or facts. <Link href="/privacyPolicy" className='underline'>SuperSeven ChatGPT October Version@2023</Link></p>
      </div>
      <Footer/>
    </div>
  );
