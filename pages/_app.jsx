...
export const metadata = {
    title: 'SuperAI | The  ',
    description: 'The Platform of Ai Tools | Nahuel Cabrera',
    keywords: 'artificial intelligence, machine learning, deep learning,adil,Nahuel Cabrera',
...
const MyApp = ({ Component, session, pageProps }) => {
    ...
    return (
        <SessionProvider session={session}>
            ...
            <meta property="twitter:title" content="SuperAI | The Group of Ai Tools" />
            ...
            <meta property="og:title" content="SuperAI | The Group of Ai Tools" />
